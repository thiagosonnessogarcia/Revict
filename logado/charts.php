    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- Breadcrumbs-->
          <ol class="breadcrumb">
            <li class="breadcrumb-item active">Tabela de Cadastro/Dívidas</li>
          </ol>

          <!-- Area Chart Example-->
          <div class="card mb-4">
            <div class="card-header">Area das Dívidas</div>
            
        <meta charset="utf-8">
        <link href="css/bootstrap.min.css" rel="stylesheet">
        <script src="js/bootstrap.min.js"></script>
          
          <!-- ./container-cadastro-crudsw -->
          <body>
              <div class="jumbotron">
              <div class="container">
                  <div class="row">
                      <h1> CRUD em PHP - Thiago /\/\ TESTE /\/\</h1>
                  </div>
                  </br>
                  <div class="row">
                      <p>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="loggout.php">Sair</a>
          </div>
        </div>
      </div>
    </div>
