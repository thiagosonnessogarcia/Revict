    ...
    <body>
        <div class="container">
            <div clas="span10 offset1">
                <div class="row">
                    <h3 class="well"> Adicionar Dívida </h3>
                    <form class="form-horizontal" action="create.php" method="post">
                        ...
                        <div class="control-group <?php echo !empty($valordividaErro)?'error ': '';?>">
                            <label class="control-label">Valor Dívida</label>
                            <div class="controls">
                                <input size="30" name="valordivida" type="text" placeholder="Valor Dívida" required="" value="<?php echo !empty($valordivida)?$valordivida: '';?>">
